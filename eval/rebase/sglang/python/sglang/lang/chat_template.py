...
@register_chat_template_matching_function
def match_deepseek_r1(model_path: str):
    model_path = model_path.lower()
    if "deepseek" in model_path and ("r1" in model_path or "distill" in model_path):
        print("Matching deepseek-r1 template")
        return get_chat_template("deepseek-r1")
...
if __name__ == "__main__":
    ...
    template = get_chat_template("deepseek-r1")
